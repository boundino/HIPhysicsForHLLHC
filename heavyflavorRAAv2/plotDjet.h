    ...
    for(int i=0;i<nPtBins;i++)
      {
        ...
        Double_t ayPP[nDrBins], aeyPPsyst_before[nDrBins], aeyPPsyst_after[nDrBins], ayPbPb[nDrBins], aeyPbPbsyst_before[nDrBins], aeyPbPbsyst_after[nDrBins], ayRatio[nDrBins], aeyRatiosyst_before[nDrBins], aeyRatiosyst_after[nDrBins];
        ...
        for(int j=0;j<nDrBins;j++)
          {
            ...
            aeyPPsyst_before[j] = vaeyPPsyst.at(i).at(j);
            aeyPPsyst_after[j] = vaeyPPsyst.at(i).at(j)/lumi_weight_pp;
            ayPbPb[j] = vayPbPb.at(i).at(j);
            aeyPbPbsyst_before[j] = vaeyPbPbsyst.at(i).at(j);
            aeyPbPbsyst_after[j] = vaeyPbPbsyst.at(i).at(j)/lumi_weight_PbPb;
            ayRatio[j] = vayRatio.at(i).at(j);
            aeyRatiosyst_before[j] = vaeyRatiosyst.at(i).at(j);
            aeyRatiosyst_after[j] = vaeyRatiosyst.at(i).at(j)/lumi_weight_PbPb;
          }
